const AboutProfile = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
      ...
      <div className="lg:col-span-5 bg-deep-800/80 border border-border-500 rounded-xl p-6 shadow-lg">
        <div className="space-y-4 text-slate-300 leading-relaxed">
          <p>
            Soy un Developer Web con experiencia en la creación de interfaces de usuario y el desarrollo de servicios backend. Mi enfoque principal está en el desarrollo backend con tecnologías como Node.js, NestJS y Express, complementando mi perfil con experiencia práctica en el frontend utilizando React y Next.js.
          </p>
          <p>
